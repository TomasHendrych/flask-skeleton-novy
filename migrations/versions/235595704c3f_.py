...
Revision ID: 235595704c3f
Revises: None
Create Date: 2019-10-08 08:36:51.539198

"""

# revision identifiers, used by Alembic.
revision = '235595704c3f'
down_revision = None
...
def upgrade():
    ...
    op.create_index('ix_vozidla_spz', 'vozidla', ['spz'], unique=False)
    ...
    op.create_table('vypis',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('rodic', sa.String(), nullable=False),
    sa.Column('dite', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_vypis'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_vypis_dite', 'vypis', ['dite'], unique=False)
    op.create_index('ix_vypis_rodic', 'vypis', ['rodic'], unique=False)
...
def downgrade():
    ...
    op.drop_table('child')
    op.drop_index('ix_vypis_rodic', table_name='vypis')
    op.drop_index('ix_vypis_dite', table_name='vypis')
    op.drop_table('vypis')
